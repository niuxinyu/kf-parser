...
(function () {
    ...
    define("char/text", [
        ...
        var kity = require("kity");
        var FONT_CONF = require("sysconf").font;
        var FontManager = require("font/manager");
        var TextFactory = require("char/text-factory");
        ...
        return kity.createClass("Text", {
            ...
            constructor: function (content, fontFamily) {
                ...
                this.contentShape = new kity.Group();
                if (typeof this.translationContent !== 'string') {
                    this.contentNode = this.translationContent;
                } else {
            ...
            translation: function (content) {
                ...
                return content.replace(/``/g, "\u201c").replace(/\\([a-zA-Z,]+)\\/g, function (match, input) {
                    ...
                    // 这里可以通过 text2svg 再尝试转换一遍
                    // 如果不可以 则抛出错误
                    // 纯渲染难度不大
                    // 问题是编辑时需要走它自己的逻辑
                    if (!data) {
                        // const res = MathJax.tex2svg(content);
    ...
    define("expression/compound-exp/radical", [
        ...
        var RadicalOperator = require("operator/radical");
    ...
    define("expression/text", [
        ...
        var kity = require("kity");
        var FONT_CONF = require("char/conf");
        var Expression = require("expression/expression");

        var TextExpression = kity.createClass("TextExpression", {
            base: require("expression/expression"),
            constructor: function (content, fontFamily) {
                this.callBase();
    ...
    define("operator/brackets", [
        ...
        function generate(exp) {
            ...
            var right = this.getParentExpression().getRightSymbol();
            var fontSize = exp.getFixRenderBox().height;
            var group = new kity.Group();
            var offset = 0;
            var leftOp = new Text(left, "KF AMS MAIN").fill("black");
            var rightOp = new Text(right, "KF AMS MAIN").fill("black");
    ...
    define("operator/func", [
        ...
        var kity = require("kity");
        var Text = require("char/text");
        var ScriptController = require("operator/common/script-controller");
        ...
        return kity.createClass("FunctionOperator", {
            ...
            applyOperand: function (expr, sup, sub) {
                ...
                var scriptHanlder = this.parentExpression.isSideScript() ? "applySide" : "applyUpDown";
                var space = new ScriptController(this, opShape, sup, sub, {
                    zoom: .5
    ...
    define("operator/radical", [
        ...
        var kity = require("kity");
        // 线段基本宽度
        var SHAPE_DATA_WIDTH = 1;
        var radians = 2 * Math.PI / 360;

        var sin15 = Math.sin(15 * radians);
        var cos15 = Math.cos(15 * radians);
        var tan15 = Math.tan(15 * radians);
        ...
        function generateOperator(radicand, exponent) {
            ...
            var vLine = generateVLine(radicand);
            var padding = 5;
            var hLine = generateHLine(radicand);
        ...
        function generateDecoration(radicand) {
            ...
            var a = SHAPE_DATA_WIDTH;
            var h = radicand.getHeight() / 3;
